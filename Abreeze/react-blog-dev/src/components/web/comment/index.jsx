  ...
  handleSubmit = () => {
    ...
    this.setState({ submitting: true })
      ...
      axios({
          url:'/user/comment',
          method: 'post',
          data: {article: this.props.articleId, content: this.state.value},
          headers:{
              Authorization:' JWT '+token
          }
      })
        .then(res => {
          this.setState({ submitting: false, value: '' }, () => this.props.setCommentList(res.results))
        })
        .catch(err => this.setState({ submitting: false }))

    // axios
    //   .post('/user/comment', { article: this.props.articleId, content: this.state.value })
    //   .then(res => {
